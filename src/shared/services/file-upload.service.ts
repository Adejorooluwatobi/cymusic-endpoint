...
export class FileUploadService {
  ...
  async uploadAudioFile(file: Multer.File): Promise<string> {
  ...
  async uploadImageFile(file: Multer.File): Promise<string> {
  ...
  private validateAudioFile(file: Multer.File): void {
  ...
  private validateImageFile(file: Multer.File): void {
